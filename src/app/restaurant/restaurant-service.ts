...
export class RestaurantService {
  ...
  getRestaurant(id: number): Observable<any> {
    return this.httpClient.get<RestaurantItem>('https://localhost:8080/main/restaurants/' + id).pipe(tap(response => {
  ...
  addRestaurant(restaurant: Restaurant): Observable<any> {
    return this.httpClient.post('https://localhost:8080/main/restaurants/new', restaurant);
  }

  editRestaurant(restaurant: Restaurant): Observable<any> {
    return this.httpClient.put('https://localhost:8080/main/restaurants/edit', restaurant);
  }

  deleteRestaurant(id: number): Observable<any> {
    return this.httpClient.delete('https://localhost:8080/main/restaurants/' + id + '/delete');
  }

  uploadFile(file: File, restaurantId: number): Observable<any> {
    const url = 'https://localhost:8080/main/restaurants/' + restaurantId + '/uploadLogo/';
  ...
  addAccountForRestaurant(restaurantId: number, restaurantAccount: RestaurantAccount): Observable<any> {
    return this.httpClient.post('https://localhost:8080/main/restaurants/' + restaurantId + '/account/add',
      restaurantAccount);
  }
